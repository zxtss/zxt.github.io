(function ($) {
     ...
     propertyObject = function (option) {
          var opt = {
               ...
               datatype: {
                    ...
                    required: false,
                    editable: true,
                    options: [{ id: 'String', text: "字符串" }, { id: 'Integer', text: "整数" }, { id: 'Date', text: "日期" }, { id: 'Boolean', text: "布尔" }, { id: 'Array', text: "数组" }, { id: 'Object', text: "对象" }]
               },
               mappingtype: {
                    format: "single",
                    title: "映射类型",
                    required: false,
                    editable: true,
                    options: [{ id: "Object", text: "子对象" }, { id: "Array", text: "数组" }]
               },
               matchcriteria: {
                    format: "list",
                    title: "匹配条件",
     ...
     picture = function (option) {
          ...
          $.extend(opt, option);
          $.extend(this, new actionWidget(opt));
          this.allowconnectionPoint = false;//是否允许划线
          this.type = "picture";
          this.persist = function () {
               var r = widget.persistproperty(this);
               if (this.paragraph) {
     ...
     triangle = function (option) {
          var opt = {
               ...
               afterfunctionPoint: function (ev) {
                    console.log('控件功能点改变时发生执行的方法',ev)
